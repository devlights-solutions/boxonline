...
$cons = mysql_query("SELECT * FROM submenu  where id = 10 and subid = 92");
...
<title>BOX - Ensalada de la granja</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
				...
				<img src="images/img-ensaladas-granja.png" width="562" height="530" alt="Imagen Ensalada de la Granja" />
