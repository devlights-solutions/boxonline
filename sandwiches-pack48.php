...
$cons = mysql_query("SELECT * FROM submenu  where id = 7 and subid = 152");
...
<title>BOX - Sandwiches Pack 48</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-sandwiches-pack48.png" width="562" height="528" alt="Sandwiches Pack 48" />
