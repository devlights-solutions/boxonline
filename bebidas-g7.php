...
$cons = mysql_query("SELECT * FROM submenu  where id = 16 and subid = 127"); //fanta chica
                     ...
                     <!--/// wrapper precio-->
                        ...
                        <div id="bot-gaseosas">
                        	<ul id="bot-gaseosas">
                                ...
                                <li><a href="bebidas-g7.php" target="_self"><span class="btn7_active"></span></a></li>
