...
$cons = mysql_query("SELECT * FROM submenu  where id = 16 and subid = 120"); //fanta lata
                     ...
                     <!--/// wrapper precio-->
                        ...
                        <div id="bot-gaseosas">
                        	<ul id="bot-gaseosas">
                                ...
                                <li><a href="bebidas-g3.php" target="_self"><span class="btn3_active"></span></a></li>
