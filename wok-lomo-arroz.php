...
$cons = mysql_query("SELECT * FROM submenu  where id = 8 and subid = 74");
...
<title>BOX - Wok de lomo con vegetales y arroz</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-wok-lomo-arroz.png" alt="Imagen Calzoncillo Fugaceta" width="562" height="530" border="0" usemap="#Map" />
                    <map name="Map" id="Map">
                      <area shape="rect" coords="10,339,263,496" href="wok-lomo-veg.php" target="_self" />
                      <area shape="rect" coords="301,352,536,493" href="wok-lomo-fideos.php" target="_self" />
                    </map>
