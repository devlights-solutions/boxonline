...
$cons = mysql_query("SELECT * FROM submenu  where id = 13 and subid = 109");
...
<div class="left w-800">
  <div class="left w-372"><img src="images/img-papas-manidbox.jpg" width="372" height="548" /></div>
	<div id="precio-fritas" class="left">
    	<span class="f-mandibox">
        ...
        <div id="bot-fritas">
                    	<ul id="bot-fritas">
                        	<li><a href="fritas-papas.php"><span class="btn1">Papas Fritas</span></a></li>
                            <li><a href="#"><span class="btn2_active">Mando Box</span></a></li>
                            <li><a href="fritas-smiles.php"><span class="btn3">Smile</span></a></li>
                            <li><a href="fritas-apuai.php"><span class="btn4">Apuaí</span></a></li>
              </ul>
            </div>
        <!-- /// botonera-->
        </div>
