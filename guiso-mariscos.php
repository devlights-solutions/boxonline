...
$cons = mysql_query("SELECT * FROM submenu  where id = 17 and subid = 162");
...
<title>BOX - Guiso de mariscos</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-guisos-mariscos.png" width="562" height="501" alt="Imagen Guiso de mariscos" />
...
<!-- InstanceEndEditable --></div>
				...
				<div id="precio-g">
               	  <span class="g-mariscos">
                        ...
                        <!-- Agregado-->
                        <div class="agregados-guiso">
                        <ul class="gallery"><li><a href="agregados-guisos.php?iframe=true&amp;width=680&amp;height=451" rel="prettyPhoto[iframe]"><img src="images/btn-wok-agregados.gif" width="192" height="38" /></a></li>
                        </ul>
                      </div>
                    </span>
                </div>
            ...
            <div class="w-905"><!-- InstanceBeginEditable name="botonera" -->
            	...
            	<!-- centra botonera-->
                <div class="w-895">
                	<div id="bot-guiso" class="p_T_18 p_B_18">
                    	<ul id="bot-guiso">
                        	<li><a href="guiso-carne.php" target="_self"><span class="btn1">Carne</span></a></li>
                            <li><a href="guiso-pollo.php" target="_self"><span class="btn2">Pollo</span></a></li>
                            <li><a href="guiso-mondongo.php" target="_self"><span class="btn3">Mondongo</span></a></li>
                            <li><a href="guiso-lentejas.php" target="_self"><span class="btn4">Lentejas</span></a></li>
                            <li><a href="guiso-calamar.php" target="_self"><span class="btn5">Calamar</span></a></li>
                            <li><a href="guiso-mariscos.php" target="_self"><span class="btn6">Mariscos</span></a></li>
                            <li><a href="guiso-arroz.php" target="_self"><span class="btn7">Arroz</span></a></li>
                        </ul>
                        <div class="clear"></div>
                    </div>
