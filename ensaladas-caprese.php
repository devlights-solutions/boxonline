...
$cons = mysql_query("SELECT * FROM submenu  where id = 10 and subid = 93");
...
<title>BOX - Ensalada caprese</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
				...
				<img src="images/img-ensaladas-caprese.png" width="562" height="530" alt="Imagen Ensalada de la Granja" />
                <!--ADD THIS-->
