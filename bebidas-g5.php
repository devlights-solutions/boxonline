...
$cons = mysql_query("SELECT * FROM submenu  where id = 16 and subid = 128"); //coca zero chica
                     ...
                     <!--/// wrapper precio-->
                        ...
                        <div id="bot-gaseosas">
                        	<ul id="bot-gaseosas">
                                ...
                                <li><a href="bebidas-g5.php" target="_self"><span class="btn5_active"></span></a></li>
