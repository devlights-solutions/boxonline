...
$cons = mysql_query("SELECT * FROM submenu  where id = 17 and subid = 160");
...
<title>BOX - Guiso de lentejas</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-guisos-lentejas.png" width="562" height="501" alt="Imagen Guiso de lentejas" />
