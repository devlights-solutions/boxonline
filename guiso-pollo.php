...
$cons = mysql_query("SELECT * FROM submenu  where id = 17 and subid = 158");
...
<title>BOX - Guiso de pollo</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-guisos-pollo.png" width="562" height="501" alt="Imagen Guiso de pollo" />
