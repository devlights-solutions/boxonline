...
$cons = mysql_query("SELECT * FROM submenu  where id = 19 and subid = 169");
...
<title>BOX - Tartines Champignones</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-tartines-champignones.png" width="560" height="530" alt="Imagen tartines champignones" />
