...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/institucional.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />

<!-- InstanceBeginEditable name="doctitle" -->
<title>BOX - La empresa</title>
<!-- InstanceEndEditable -->
...
<div id="4bloque_bg" class="bg-4bloque">
	<div class="w-980">
    	<div id="body">
            ...
            <p>&nbsp;<br /></p>
            <img src="images/promo-dia-amigo.png" />
            <p>&nbsp;<br />&nbsp;</p>
			<!-- InstanceEndEditable -->
            <!--/// w 950 botonera-->
