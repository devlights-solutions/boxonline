...
$cons = mysql_query("SELECT * FROM submenu  where id = 2 and subid = 29");
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-calzoncillo-especial.png" width="560" height="530" alt="Imagen Calzoncillo Fugaceta" />
