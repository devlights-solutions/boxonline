...
$cons = mysql_query("SELECT * FROM submenu  where id = 10 and subid = 88");
$consrow=mysql_fetch_array($cons);
$precio1 = $consrow['subPrecio1'];
$precio2 = $consrow['subPrecio2'];
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/light-pizzetas.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />

<!-- InstanceBeginEditable name="doctitle" -->
<title>BOX - Pizzeta light especial</title>
<!-- InstanceEndEditable -->
            ...
            <div id="menu" class="left">
            	<div id="barra" >
               	  <div id="barra-inner" class="left bg-barra-inner">
                  	<ul id="barra-inner">
                   	  <li><a href="ensaladas-marina.php"><span class="btn1">ensaladas</span></a></li>
                        <li><a href="sandwiches-light-figazza.php"><span class="btn2">sandwiches light</span></a></li>
                        <li><a href="pizzetas-light-muzzarella.php"><span class="btn3_active">pizzetas de salvado</span></a></li>
                        </ul>
                  </div>
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
				...
				<img src="images/img-pizzetas-especial.png" width="560" height="530" alt="Imagen Ensalada de la Granja" />
            ...
            <!-- centra botonera-->
                <div class="w-852">
                	<div id="bot-pizzetas" class="p_T_18 p_B_18">
                    	<ul id="bot-pizzetas">
                        	<li><a href="pizzetas-light-muzzarella.php" target="_self"><span class="btn1">Ensalada Marina</span></a></li>
                            <li><a href="#"><span class="btn2_active">pizzas</span></a></li>
                            <li><a href="pizzetas-light-rucula.php" target="_self"><span class="btn3">pizzas</span></a></li>
                            <li><a href="pizzetas-light-atun.php" target="_self"><span class="btn4">pizzas</span></a></li>
                        </ul>
                        <div class="clear"></div>
                    </div>
                </div>
