...
$cons = mysql_query("SELECT * FROM submenu  where id = 1 and subid = 14");//pizza roquefort
...
<title>BOX - Pizza roquefort</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-pizzas-roque.png" width="562" height="339" alt="Imagen Empanadas &aacute;rabes" />
		...
		<div class="images_container">
            ...
            <!--2-->
                ...
                <a href="pizzas-napolitana.php"><img src="images/p-off-napolitana.png"></a>
		  		<a href="pizzas-roquefort.php"><img src="images/p-on-roquefort.png"></a>
