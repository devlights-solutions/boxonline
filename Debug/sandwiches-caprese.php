...
$cons = mysql_query("SELECT * FROM submenu  where id = 7 and subid = 66");
...
<title>BOX - Sandwich Simple triple caprese</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-sandwich-triplecaprese.png" width="562" height="342" alt="Imagen Empanadas &aacute;rabes" />
...
<div class="mCustomScrollBox mCS-light mCSB_horizontal" id="mCSB_2" style="position:relative; height:100%; overflow:hidden; max-width:100%;"><div class="mCSB_container" style="position: relative; left: 0px; width: 4081px;">
		<div class="images_container">
            ...
            <!--2-->
                 ...
                 <a href="sandwiches-caprese.php"><img src="images/s-on-triplecaprese.png" /></a>
