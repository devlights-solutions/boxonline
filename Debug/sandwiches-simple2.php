...
$cons = mysql_query("SELECT * FROM submenu  where id = 7 and subid = 60");
$consrow=mysql_fetch_array($cons);
$precio1 = $consrow['subPrecio1'];
$precio2 = $consrow['subPrecio2'];
?>   
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/sandwiches2.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />

<!-- InstanceBeginEditable name="doctitle" -->
<title>BOX - Sandwiches - Simple de jam&oacute;n y queso</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-sandwich-simple.png" width="562" height="342" alt="Imagen Empanadas &aacute;rabes" />
...
<div class="mCustomScrollBox mCS-light mCSB_horizontal" id="mCSB_2" style="position:relative; height:100%; overflow:hidden; max-width:100%;"><div class="mCSB_container" style="position: relative; left: 0px; width: 4081px;">
		<div class="images_container">
            ...
            <!--1-->
            	<a href="sandwiches-simple.php"><img src="images/s-off-simplejamonqueso.png" /></a>
                <a href="sandwiches-triplejamon.php"><img src="images/s-off-triplejamonqueso2.png"/></a>
                <a href="sandwiches-triple.php"><img src="images/s-off-triple.png" /></a>
                <a href="sandwiches-tripleespecial.php"><img src="images/s-off-tripleespecial.png" /></a>
            
            <!--2-->
            	 <a href="sandwiches-triplepeceto.php"><img src="images/s-off-triplepeceto.png"  /></a>
                 <a href="sandwiches-caprese.php"><img src="images/s-off-triplecaprese.png" /></a>
                 <a href="sandwiches-sicobox.php"><img src="images/s-off-sicobox.png" /></a>
            ...
            <div class="w-320 left">
            	<div id="contacto">
                	<span class="txt-corrido-28">Ven&iacute; a nuestro local,<br />
               	  te esperamos en D&oacute;novan 21.
                  <br />
                    <br />
                    <br />
                    Lunes a Domingos<br />
