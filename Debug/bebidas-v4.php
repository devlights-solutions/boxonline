...
$cons = mysql_query("SELECT * FROM submenu  where id = 16 and subid = 137"); //Vino Cabernet Sauvignon 750cm3
                     ...
                     <!--/// wrapper precio-->
                        ...
                        <div id="bot-vinos">
                        	<ul id="bot-vinos">
                                ...
                                <li><a href="bebidas-v4.php" target="_self"><span class="btn4_active"></span></a></li>
                                <li><a href="bebidas-v2.php" target="_self"><span class="btn5"></span></a></li>
                            </ul>
                        </div>
                    </div>
