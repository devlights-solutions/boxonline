...
$cons = mysql_query("SELECT * FROM submenu  where id = 10 and subid = 86");
...
<title>BOX - Sandwich light triple de at&uacute;n</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
				...
				<img src="images/img-sndwlight-triple-atun.png" width="562" height="530" alt="Imagen Ensalada de la Granja" />
