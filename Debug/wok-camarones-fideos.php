...
<title>BOX - Wok de camarones con vegetales y fideos de arroz</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-wok-camarones-fideos.png" alt="Imagen Calzoncillo Fugaceta" width="562" height="530" border="0" usemap="#Map" />
                    <map name="Map" id="Map">
                      <area shape="rect" coords="10,339,263,496" href="wok-camarones-veg.php" target="_self" />
                      <area shape="rect" coords="303,352,538,493" href="wok-camarones-arroz.php" target="_self" />
                    </map>
