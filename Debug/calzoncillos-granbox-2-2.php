	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" -->image<!-- InstanceEndEditable --></div>
                <div class="col354 left"><!-- InstanceBeginEditable name="texto" -->texto<!-- InstanceEndEditable --></div>
                <div class="clear"></div>
            ...
            <!-- w 950 botonera-->
            <div class="w-905"><!-- InstanceBeginEditable name="botonera" -->botonera<!-- InstanceEndEditable --></div>
            <!--/// w 950 botonera-->
