...
$cons = mysql_query("SELECT * FROM submenu  where id = 16 and subid = 126"); //sprite chica chica
                     ...
                     <!--/// wrapper precio-->
                        ...
                        <div id="bot-gaseosas">
                        	<ul id="bot-gaseosas">
                                ...
                                <li><a href="bebidas-g6.php" target="_self"><span class="btn6_active"></span></a></li>
