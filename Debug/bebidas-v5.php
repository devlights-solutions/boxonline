...
$cons = mysql_query("SELECT * FROM submenu  where id = 16 and subid = 138"); //VVino Chardonay 750 cm3
                     ...
                     <!--/// wrapper precio-->
                        ...
                        <div id="bot-vinos">
                        	<ul id="bot-vinos">
                                ...
                                <li><a href="bebidas-v5.php" target="_self"><span class="btn3_active"></span></a></li>
