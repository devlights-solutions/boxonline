...
$cons = mysql_query("SELECT * FROM submenu  where id = 10 and subid = 87");
...
<title>BOX - Pizzeta light muzzarella</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
				...
				<img src="images/img-pizzetas-muzzarella.png" width="560" height="530" alt="Imagen Ensalada de la Granja" />
            ...
            <!-- centra botonera-->
                <div class="w-852">
                	<div id="bot-pizzetas" class="p_T_18 p_B_18">
                    	<ul id="bot-pizzetas">
                        	<li><a href="#"><span class="btn1_active">Ensalada Marina</span></a></li>
