...
$cons = mysql_query("SELECT * FROM submenu  where id = 10 and subid = 89");
...
<title>BOX - Pizzeta light rucula</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
				...
				<img src="images/img-pizzetas-rucula.png" width="560" height="530" alt="Imagen Ensalada de la Granja" />
                ...
                <div class="w-852">
                	<div id="bot-pizzetas" class="p_T_18 p_B_18">
                    	<ul id="bot-pizzetas">
                            ...
                            <li><a href="pizzetas-light-especial.php" target="_self"><span class="btn2">pizzas</span></a></li>
                            <li><a href="#"><span class="btn3_active">pizzas</span></a></li>
