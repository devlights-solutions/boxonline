...
$cons = mysql_query("SELECT * FROM submenu  where id = 16 and subid = 122"); //villavicencio con gas 500cm3
                     ...
                     <!--/// wrapper precio-->
                        ...
                        <div id="bot-aguas">
                        	<ul id="bot-aguas">
                                ...
                                <li><a href="bebidas-a3.php" target="_self"><span class="btn3_active"></span></a></li>
                                <li><a href="bebidas-a4.php" target="_self"><span class="btn4"></span></a></li>
                            </ul>
                        </div>
                    </div>
