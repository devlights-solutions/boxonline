...
$cons = mysql_query("SELECT * FROM submenu  where id = 2 and subid = 20");
...
<title>BOX - Calzoncillo especial</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-calzoncillo-pruebaborrar.png" width="560" height="530" alt="Imagen Calzoncillo Fugaceta" />
                ...
                <div class="w-895">
                	<div id="bot-calzoncillo" class="p_T_18 p_B_18">
                    	<ul id="bot-calzoncillo">
                            ...
                            <li><a href="calzoncillos-napolitano.php"><span class="btn2">Calxon Napolitano</span></a></li>
                            <li><a href="calzoncillos-granbox.php"><span class="btn3">Calzoncillo Gran Box</span></a></li>
                            <li><a href="calzoncillos-especial.html"><span class="btn4_active">Calzoncillo Especial</span></a></li>
                        </ul>
                        <div class="clear"></div>
                    </div>
                </div>
