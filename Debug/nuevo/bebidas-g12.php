...
$cons = mysql_query("SELECT * FROM submenu  where id = 16 and subid = 132"); //gas light grande
                     ...
                     <!--/// wrapper precio-->
                        ...
                        <div id="bot-gaseosas">
                        	<ul id="bot-gaseosas">
                                ...
                                <li><a href="bebidas-g12.php" target="_self"><span class="btn12_active"></span></a></li>
