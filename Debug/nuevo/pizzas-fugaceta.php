...
$cons = mysql_query("SELECT * FROM submenu  where id = 1 and subid = 10");//pizza fugaceta
...
<title>BOX - Pizza fugaceta</title>
<!-- InstanceEndEditable -->
            	...
            	<div id="barra" >
               	  <div id="barra-inner" class="left bg-barra-inner">
                  	<ul id="barra-inner">
                        ...
                        <li><a href="empanadas-criollas.html"><span class="btn2">empanadas</span></a></li>
                        <li><a href="hamburguesas-comun.html"><span class="btn3">hambuerguesas y lomos</span></a></li>
                        <li><a href="sandwiches-simple.html"><span class="btn4">sandwiches</span></a></li>
                        <li><a href="calzoncillos-fugaceta.html"><span class="btn5">calzones</span></a></li>
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-pizzas-imgprueba.png" width="562" height="339" alt="Imagen Empanadas &aacute;rabes" />
				<div class="opciones-pizzaslight">
                	<div class="left">
                    	<a href="pizzetas-light-muzarella.html"><img src="images/blank-opciones.gif" /></a>
                    </div>
                    <div class="left">
                    	<a href="pizzetas-light-especial.html"><img src="images/blank-opciones.gif" /></a>
                    </div><div class="left">
                    	<a href="pizzetas-light-rucula.html"><img src="images/blank-opciones.gif" /></a>
                    </div><div class="left">
                    	<a href="pizzetas-light-atun.html"><img src="images/blank-opciones.gif" /></a>
                    </div>
                    <div class="clear"></div>
            ...
            <object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="895" height="150">
              <param name="movie" value="bot-piz1-fug.swf" />
              ...
              <!--[if !IE]>-->
              <object type="application/x-shockwave-flash" data="bot-piz1-fug.swf" width="895" height="150">
                <!--<![endif]-->
                <param name="quality" value="high" />
                <param name="wmode" value="transparent" />
                <param name="swfversion" value="6.0.65.0" />
