...
$cons = mysql_query("SELECT * FROM submenu  where id = 16 and subid = 118"); //coca cola lata
                ...
                <div class="left w-541">
                    ...
                    <div id="precio-gaseo">
                     ...
                     <!--/// wrapper precio-->
                        ...
                        <div id="bot-gaseosas">
                        	<ul id="bot-gaseosas">
                            	<li><a href="bebidas-g1.php" target="_self"><span class="btn1_active"></span></a></li>
