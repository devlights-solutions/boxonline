...
$cons = mysql_query("SELECT * FROM submenu  where id = 5 and subid = 51");
...
<title>BOX - Hamburguesa Completa</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-hambur-completa.png" width="562" height="342" alt="Imagen Empanadas &aacute;rabes" />
