...
$cons = mysql_query("SELECT * FROM submenu  where id = 10 and subid = 84");
...
<title>BOX - Sandwich light de figaza</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
				...
				<img src="images/img-sndwlight-mixtofigaza.png" width="562" height="530" alt="Imagen Ensalada de la Granja" />
                ...
                <div class="w-853">
                	<div id="bot-sndw-light" class="p_T_18 p_B_18">
                    	<ul id="bot-sndw-light">
                            ...
                            <li><a href="sandwiches-light-pollo.php" target="_self"><span class="btn2">pizzas</span></a></li>
