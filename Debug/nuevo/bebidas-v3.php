...
$cons = mysql_query("SELECT * FROM submenu  where id = 16 and subid = 136"); //Vino Malbec 750cm3  
                     ...
                     <!--/// wrapper precio-->
                        ...
                        <div id="bot-vinos">
                        	<ul id="bot-vinos">
                                ...
                                <li><a href="bebidas-v3.php" target="_self"><span class="btn2_active"></span></a></li>
