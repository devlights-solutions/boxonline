...
$tucorreo = "luciana@brandonlatina.com";
...
if ($_POST['action'] == "checkdata") {
	if($name == '') {
            $var = "<p style='color: #ff0000;'><strong>You must write your name.</strong></p>";
		}
		elseif($email == '') {
			$var = "<p style='color: #ff0000;'><strong>You may leave a MAIL contact.</strong></p>";
		}
...
<div class="w-800">
 ...
 <form id="form1" name="form1" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        <label class="label"><img src="images/form-nombre.png" />
          <input name="name" type="text" id="name" class="campo" size="25" value="<?php echo $name; ?>" />
   </label>
  <p>
