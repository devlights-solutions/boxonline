...
$cons = mysql_query("SELECT * FROM submenu  where id = 12 and subid = 105");
$consrow=mysql_fetch_array($cons);
$precio1 = $consrow['subPrecio1'];
$precio2 = $consrow['subPrecio2'];
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/productos-lunch.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />

<!-- InstanceBeginEditable name="doctitle" -->
<title>BOX - Lunch Premium</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col484 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-lunch-premium.png" width="484" height="529" alt="Imagen Lunch Premium" />
				
				<!--ADD THIS-->
                    <div class="left col421 p_T_10">
            ...
            <!--/// ADD THIS-->
                ...
                <div class="col421 left"><!-- InstanceBeginEditable name="texto" -->
				<div id="precio-lunch">
       	    <span class="lu-premium">
                    
                    	<div class="w-peso-lunch">
                        	<div class="left">
                            	<ul class="gallery">
                            		<li> <a href="opciones-lunch.php?iframe=true&amp;width=810&amp;height=571" rel="prettyPhoto[iframe]">
                            	<img src="images/btn-opciones-lunch.jpg" /></a></li></ul>
                            </div>
                            <div class="right">
                            	<div class=" pesos">
                                	<span class="costo-decimales">
                                      <?php 
			...
			<div class="w-895">
                	<div id="bot-lunch" class="p_T_18 p_B_18">
                    	<ul id="bot-lunch">
                        	<li><a href="lunch-premium.php" target="_self"><span class="btn1_active">Lunch Premium</span></a></li>
                            <li><a href="lunch-special.php" target="_self"><span class="btn2">Lunch Special</span></a></li>
                            <li><a href="lunch-brindis.php" target="_self"><span class="btn3">Lunch Brindis</span></a></li>
                        </ul>
                        <div class="clear"></div>
                    </div>
                </div>
...
target="_F960AFIPInfo">Formulario 960 MN</a></span>
...
mejorar d&iacute;a a d&iacute;a tu experiencia.</span>
              ...
              <div class="p_T_10">
                    	...
                    	<ul class="gallery">
                            <li>
                                <a href="contactobox.php?iframe=true&amp;width=550&amp;height=560" rel="prettyPhoto"><span class="btn">Consultas</span>
                                </a>
                            </li>
                         </ul>
