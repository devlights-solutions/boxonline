...
$cons = mysql_query("SELECT * FROM submenu  where id = 16 and subid = 143"); //Schneider Long Neck
                ...
                <div class="left w-541">
                    ...
                    <div id="precio-cer">
                     ...
                     <!--/// wrapper precio-->
                        ...
                        <div id="bot-cervezas">
                        	<ul id="bot-cervezas">
                            	<li><a href="bebidas-c1.php" target="_self"><span class="btn1"></span></a></li>
                                <li><a href="bebidas-c2.php" target="_self"><span class="btn2"></span></a></li>
                                <li><a href="bebidas-c3.php" target="_self"><span class="btn3"></span></a></li>
                                <li><a href="bebidas-c4.php" target="_self"><span class="btn4"></span></a></li>
                                <li><a href="bebidas-c5.php" target="_self"><span class="btn5_active"></span></a></li>
                                <li><a href="bebidas-c6.php" target="_self"><span class="btn6"></span></a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="w-740">
                	<div id="bot-bebidas" class="p_T_18 p_B_18">
                    	<ul id="bot-wok">
                            ...
                            <li><a href="bebidas-c1.php" target="_self"><span class="btn3_active">Cervezas</span></a></li>
