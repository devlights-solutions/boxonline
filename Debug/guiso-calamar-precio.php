...
$cons = mysql_query("SELECT * FROM submenu  where id = 17 and subid = 161");
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-guisos-calamar.png" width="562" height="501" alt="Imagen Guiso calamar" />
			  ...
			  <!-- InstanceEndEditable --></div>
				...
				<div id="precio-g">
                	<span class="g-calamar">
                    	<div class="inner-precio-g">
                     ...
                     <!-- Agregado-->
                        ...
                        <ul class="gallery">
                            <li>
                                <a href="agregados-guisos.php?iframe=true&amp;width=800&amp;height=548" rel="prettyPhoto[iframe]">
                        <img src="images/btn-guisos-agregados.gif" width="192" height="38" />
                      </a></li></ul>
                        </div>
...
<div class="mCustomScrollBox mCS-light mCSB_horizontal" id="mCSB_2" style="position:relative; height:100%; overflow:hidden; max-width:100%;"><div class="mCSB_container" style="position: relative; left: 0px; ">
		<div class="images_container">
        	
            <!--1-->
            <a href="guiso-carne.php"><img src="images/g-off-carne.png"  /></a>
                 <a href="guiso-pollo.php"><img src="images/g-off-pollo.png"  /></a>
				<a href="guiso-mondongo.php"><img src="images/g-off-mondongo.png"  /></a>
                <a href="guiso-lenteja.php"><img src="images/g-off-lentejas.png" /></a>
                <a href="guiso-calamar.php"><img src="images/g-on-calamar.png" class="left" /></a>
                <a href="guiso-mariscos.php"><img src="images/g-off-mariscos.png"  /></a>
 				
		</div>
</div>
<div class="mCSB_scrollTools" style="position: absolute; display: block;"><div class="mCSB_draggerContainer"><div class="mCSB_dragger" style="position: absolute; width: 144px; left: 0px;" oncontextmenu="return false;"></div><div class="mCSB_draggerRail"></div></div></div></div></div>
