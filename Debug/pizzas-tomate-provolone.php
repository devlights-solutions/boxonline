...
$cons = mysql_query("SELECT * FROM submenu  where id = 1 and subid = 18");//pizza tomate-provolone
...
<title>BOX - Pizza tomate con provolone</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-pizzas-tom-prov.png" width="562" height="339" alt="Imagen Empanadas &aacute;rabes" />
		...
		<div class="images_container">
            ...
            <!--3-->
            	<a href="pizzas-anchoa.php"><img src="images/p-off-anchoa.png"></a>
		  		...
		  		<a href="pizzas-tomate-provolone.php"><img src="images/p-on-tomateprovolone.png"></a>
