...
$cons = mysql_query("SELECT * FROM submenu  where id = 1 and subid = 15");//pizza calabresa
...
<title>BOX - Pizza calabresa</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-pizzas-cala.png" width="562" height="339" alt="Imagen Empanadas &aacute;rabes" />
		...
		<div class="images_container">
            ...
            <!--2-->
                ...
                <a href="pizzas-napolitana.php"><img src="images/p-off-napolitana.png"></a>
		  		...
		  		<a href="pizzas-calabresa.php"><img src="images/p-on-calabresa.png"></a>
            <!--3-->
