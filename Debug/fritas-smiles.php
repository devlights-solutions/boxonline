...
$cons = mysql_query("SELECT * FROM submenu  where id = 13 and subid = 110");
...
<title>BOX - Papas fritas smile</title>
...
<div class="left w-372"><img src="images/img-papas-smile.jpg" width="372" height="548" /></div>
	<div id="precio-fritas" class="left">
        ...
        <div id="bot-fritas">
                    	<ul id="bot-fritas">
                            ...
                            <li><a href="#"><span class="btn3_active">Smile</span></a></li>
