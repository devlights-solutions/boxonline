...
$cons = mysql_query("SELECT * FROM submenu  where id = 1 and subid = 17");//pizza capresse
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-pizzas-capre.png" width="562" height="339" alt="Imagen Empanadas &aacute;rabes" />
		...
		<div class="images_container">
            ...
            <!--3-->
            	<a href="pizzas-anchoa.php"><img src="images/p-off-anchoa.png"></a>
		  		<a href="pizzas-caprese.php"><img src="images/p-on-caprese.png"></a>
