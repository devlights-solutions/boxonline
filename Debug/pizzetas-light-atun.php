...
$cons = mysql_query("SELECT * FROM submenu  where id = 10 and subid = 90");
...
<title>BOX - Pizzeta light at&uacute;n</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
				...
				<img src="images/img-pizzetas-atun.png" width="560" height="530" alt="Imagen Ensalada de la Granja" />
                ...
                <div class="w-852">
                	<div id="bot-pizzetas" class="p_T_18 p_B_18">
                    	<ul id="bot-pizzetas">
                            ...
                            <li><a href="#"><span class="btn4_active">pizzas</span></a></li>
                        </ul>
                        <div class="clear"></div>
                    </div>
                </div>
