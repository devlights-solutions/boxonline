...
$cons = mysql_query("SELECT * FROM submenu  where id = 7 and subid = 63");
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-sandwich-triple.png" width="562" height="342" alt="Imagen Empanadas &aacute;rabes" />
