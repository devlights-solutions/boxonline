...
$cons = mysql_query("SELECT * FROM submenu  where id = 8 and subid = 72");
...
<title>BOX - Wok de pollo y vegetales y fideos de arroz</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-wok-pollo-veg-fideos.png" alt="Imagen Calzoncillo Fugaceta" width="562" height="530" border="0" usemap="#Map" />
                    <map name="Map" id="Map">
                      <area shape="rect" coords="10,339,263,496" href="wok-pollo-veg.php" target="_self" />
                      <area shape="rect" coords="301,352,536,493" href="wok-pollo-veg-arroz.php" target="_self" />
                    </map>
                ...
                <div class="w-895">
                	<div id="bot-wok" class="p_T_18 p_B_18">
                    	<ul id="bot-wok">
                            ...
                            <li><a href="wok-pollo-veg.php" target="_self"><span class="btn3_active">Wok de pollo</span></a></li>
