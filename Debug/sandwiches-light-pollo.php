...
$cons = mysql_query("SELECT * FROM submenu  where id = 10 and subid = 85 ");
$consrow=mysql_fetch_array($cons);
$precio1 = $consrow['subPrecio1'];
$precio2 = $consrow['subPrecio2'];
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/light-sandwiches.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />

<!-- InstanceBeginEditable name="doctitle" -->
<title>BOX - Sandwich light triple de pollo</title>
<!-- InstanceEndEditable -->
            	...
            	<div id="barra" >
               	  <div id="barra-inner" class="left bg-barra-inner">
                  	<ul id="barra-inner">
                        ...
                        <li><a href="sandwiches-light-figazza.php"><span class="btn2_active">sandwiches light</span></a></li>
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
				...
				<img src="images/img-sndwlight-triple-pollo.png" width="562" height="530" alt="Imagen Ensalada de la Granja" />
                <!--ADD THIS-->
      ...
      <!-- InstanceEndEditable --></div>
            ...
            <!-- centra botonera-->
                <div class="w-853">
                	<div id="bot-sndw-light" class="p_T_18 p_B_18">
                    	<ul id="bot-sndw-light">
                        	<li><a href="sandwiches-light-figazza.php" target="_self"><span class="btn1">Ensalada Marina</span></a></li>
                            <li><a href="sandwiches-light-pollo.html"><span class="btn2_active">pizzas</span></a></li>
                            <li><a href="sandwiches-light-atun.php" target="_self"><span class="btn3">pizzas</span></a></li>
                        </ul>
                        <div class="clear"></div>
                    </div>
                </div>
