...
$cons = mysql_query("SELECT * FROM submenu  where id = 1 and subid = 20");//pizza primavera
...
<title>BOX - Pizza tropical</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-pizzas-tropical.png" width="562" height="339" alt="Imagen Empanadas &aacute;rabes" />
...
<div class="mCustomScrollBox mCS-light mCSB_horizontal" id="mCSB_2" style="position:relative; height:100%; overflow:hidden; max-width:100%;"><div class="mCSB_container" style="position: relative; left: 0px; width: 4081px;">
		<div class="images_container">
            ...
            <!--4-->
            	<a href="pizzas-tropical.php"><img src="images/p-on-tropical.png"></a>
