...
$cons = mysql_query("SELECT * FROM submenu  where id = 1 and subid = 11");//pizza fugazzeta-panceta
...
<title>BOX - Pizza fugazzeta con panceta</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-pizzas-fuga-pance.png" width="562" height="339" alt="Imagen Empanadas &aacute;rabes" />
		...
		<div class="images_container">
            ...
            <!--1-->
                ...
                <a href="pizzas-fugazzeta.php"><img src="images/p-off-fugaceta.png"></a>
          		<a href="pizzas-fugazzeta-panceta.php"><img src="images/p-on-fugacetapanceta.png"></a>
            <!--2-->
