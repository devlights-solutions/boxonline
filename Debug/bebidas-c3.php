...
$cons = mysql_query("SELECT * FROM submenu  where id = 16 and subid = 141"); //bud no retornable
                     ...
                     <!--/// wrapper precio-->
                        ...
                        <div id="bot-cervezas">
                        	<ul id="bot-cervezas">
                                ...
                                <li><a href="bebidas-c3.php" target="_self"><span class="btn3_active"></span></a></li>
                                <li><a href="bebidas-c4.php" target="_self"><span class="btn4"></span></a></li>
                                <li><a href="bebidas-c5.php" target="_self"><span class="btn5"></span></a></li>
