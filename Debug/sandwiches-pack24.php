...
$cons = mysql_query("SELECT * FROM submenu  where id = 7 and subid = 151");
            ...
            <div class="w-916">
				...
				<div id="precio-s">
                	<span class="s-pack24">
						...
						<!-- Tabla de gustos-->
                        <div class="s-tabla-de-gustos">
							<ul class="gallery">
								<li>
									<a href="sandwiches-tabla-de-gustos.php?iframe=true&amp;width=784&amp;height=544" rel="prettyPhoto">
										<img src="images/btn-tabla-de-gustos.png" width="193" height="39" />
									</a>
								</li>
							</ul>
                        </div>
