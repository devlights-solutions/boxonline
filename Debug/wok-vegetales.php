...
$cons = mysql_query("SELECT * FROM submenu  where id = 8 and subid = 67");
...
<title>BOX - Wok de vegetales</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-wok-veg.png" alt="Imagen Calzoncillo Fugaceta" width="562" height="530" border="0" usemap="#Map" />
                    <map name="Map" id="Map">
                      <area shape="rect" coords="10,339,263,496" href="wok-vegetales-arroz.php" target="_self" />
                      <area shape="rect" coords="301,352,536,493" href="wok-vegetales-fideos.php" target="_self" />
                    </map>
            ...
            <div class="w-905"><!-- InstanceBeginEditable name="botonera" -->
                ...
                <div class="w-895">
                	<div id="bot-wok" class="p_T_18 p_B_18">
                    	<ul id="bot-wok">
                        	<li><a href="wok-vegetales.php"><span class="btn1_active">Wok de vegetales</span></a></li>
                            <li><a href="wok-lomo-veg.php"><span class="btn2">Wok de lomo</span></a></li>
                            <li><a href="wok-pollo-veg.php"><span class="btn3">Wok de pollo</span></a></li>
                            <li><a href="wok-camarones-veg.php"><span class="btn4">Wok de camarones</span></a></li>
                        </ul>
                        <div class="clear"></div>
                    </div>
                </div>
