...
$cons = mysql_query("SELECT * FROM submenu  where id = 12 and subid = 106");
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col484 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-lunch-special.png" width="484" height="529" alt="Imagen Lunch Premium" />
			...
			<div class="w-895">
                	<div id="bot-lunch" class="p_T_18 p_B_18">
                    	<ul id="bot-lunch">
                        	<li><a href="lunch-premium.php" target="_self"><span class="btn1">Lunch Premium</span></a></li>
                            <li><a href="lunch-special.php" target="_self"><span class="btn2_active">Lunch Special</span></a></li>
