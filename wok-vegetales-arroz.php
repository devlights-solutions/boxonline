...
$cons = mysql_query("SELECT * FROM submenu  where id = 8 and subid = 68");
...
<title>BOX - Wok de vegetales con arroz</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-wok-vegetales-arroz.png" alt="Imagen Calzoncillo Fugaceta" width="562" height="530" border="0" usemap="#Map" />
                    <map name="Map" id="Map">
                      <area shape="rect" coords="13,345,269,493" href="wok-vegetales.php" target="_self" alt="Ver" />
                      <area shape="rect" coords="296,347,551,495" href="wok-vegetales-fideos.php" target="_self" />
                    </map>
