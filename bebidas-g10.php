...
$cons = mysql_query("SELECT * FROM submenu  where id = 16 and subid = 130"); //gas light grande
                     ...
                     <!--/// wrapper precio-->
                        ...
                        <div id="bot-gaseosas">
                        	<ul id="bot-gaseosas">
                                ...
                                <li><a href="bebidas-g10.php" target="_self"><span class="btn10_active"></span></a></li>
