...
$cons = mysql_query("SELECT * FROM submenu  where id = 16 and subid = 129"); //coca light grande
                     ...
                     <!--/// wrapper precio-->
                        ...
                        <div id="bot-gaseosas">
                        	<ul id="bot-gaseosas">
                                ...
                                <li><a href="bebidas-g9.php" target="_self"><span class="btn9_active"></span></a></li>
                                ...
                                <li><a href="bebidas-g13.php" target="_self"><span class="btn13"></span></a></li>
                            </ul>
                        </div>
                    </div>
