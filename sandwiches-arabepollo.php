...
$cons = mysql_query("SELECT * FROM submenu  where id = 7 and subid = 150");
...
<title>BOX - Sandwich &aacute;rabe de pollo marinado</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-sandwich-arabepollo.png" width="562" height="342" alt="Imagen Empanadas &aacute;rabes" />
...
<div class="mCustomScrollBox mCS-light mCSB_horizontal" id="mCSB_2" style="position:relative; height:100%; overflow:hidden; max-width:100%;"><div class="mCSB_container" style="position: relative; left: 0px; width: 4081px;">
		<div class="images_container">
            ...
            <!--1-->
                ...
                <a href="sandwiches-triplejamon.php"><img src="images/s-off-triplejamonqueso.png"/></a>
            ...
            <!--2-->
                 ...
                 <a href="sandwiches-arabepollo.php"><img src="images/s-on-arabepollo.png" /></a>
