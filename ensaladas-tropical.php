...
$cons = mysql_query("SELECT * FROM submenu  where id = 10 and subid = 94");
...
<title>BOX - Ensalada tropical</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
				...
				<img src="images/img-ensaladas-tropical.png" width="562" height="530" alt="Imagen Ensalada de la Granja" />
