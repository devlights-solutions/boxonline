...
$cons = mysql_query("SELECT * FROM submenu  where id = 8 and subid = 77");
...
<title>BOX - Wok de camarones con vegetales y arroz</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-wok-camarones-arroz.png" alt="Imagen Calzoncillo Fugaceta" width="562" height="530" border="0" usemap="#Map" />
                    <map name="Map" id="Map">
                      <area shape="rect" coords="11,339,264,496" href="wok-camarones-veg.php" target="_self" />
                ...
                <div class="w-895">
                	<div id="bot-wok" class="p_T_18 p_B_18">
                    	<ul id="bot-wok">
                            ...
                            <li><a href="wok-camarones-veg.html" target="_self"><span class="btn4_active">Wok de camarones</span></a></li>
                        </ul>
                        <div class="clear"></div>
                    </div>
                </div>
