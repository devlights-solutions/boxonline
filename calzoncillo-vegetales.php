...
$cons = mysql_query("SELECT * FROM submenu  where id = 2 and subid = 4");
...
<title>BOX - Calzoncillo de vegetales</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
				...
				<img src="images/light/calzoncillo-vegetal.jpg" width="100%"  alt="Calzoncillo Vegetal" />
