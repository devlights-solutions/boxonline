...
$cons = mysql_query("SELECT * FROM submenu  where id = 15 and subid = 145");
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-pack-6.png" width="562" height="530" />
                ...
                <div class="w-895">
                	<div id="bot-packs" class="p_T_18 p_B_18">
                    	<ul id="bot-packs">
                            ...
                            <li><a href="promo-pack2.php"><span class="btn2">Pack2</span></a></li>
                            <li><a href="promo-pack3.php"><span class="btn3">Pack3</span></a></li>
                            <li><a href="promo-pack4.php"><span class="btn4">Pack4</span></a></li>
                            <li><a href="promo-pack5.php"><span class="btn5">Pack5</span></a></li>
                            <li><a href="promo-pack6.php"><span class="btn6_active">Pack6</span></a></li>
                        </ul>
                        <div class="clear"></div>
                    </div>
                </div>
