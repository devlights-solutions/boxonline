...
$cons = mysql_query("SELECT * FROM submenu  where id = 4 and subid = 47");
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-empanadas-disc-espanol.png" width="560" height="530" alt="Imagen Empanadas &aacute;rabes" />
...
<div class="mCustomScrollBox mCS-light mCSB_horizontal" id="mCSB_2" style="position:relative; height:100%; overflow:hidden; max-width:100%;"><div class="mCSB_container" style="position: relative; left: 0px; width: 4081px;">
		<div class="images_container">
            ...
            <!--5-->
                ...
                <a href="empanadas-discos-espanol.php" target="_self"><img src="images/e-on-dicoespanol.png"/></a>
