...
$cons = mysql_query("SELECT * FROM submenu  where id = 15 and subid = 116");
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-pack-4.png" width="562" height="530" />
                ...
                <div class="w-895">
                	<div id="bot-packs" class="p_T_18 p_B_18">
                    	<ul id="bot-packs">
                            ...
                            <li><a href="promo-pack3.php" target="_self"><span class="btn3">Pack3</span></a></li>
                            <li><a href="promo-pack4.php" target="_self"><span class="btn4_active">Pack4</span></a></li>
