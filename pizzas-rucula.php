...
$cons = mysql_query("SELECT * FROM submenu  where id = 1 and subid = 22");//pizza rucula
...
<title>BOX - Pizza recula con jam&oacute;n crudo</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-pizzas-rucula.png" width="562" height="339" alt="Imagen Empanadas &aacute;rabes" />
		...
		<div class="images_container">
            ...
            <!--4-->
            	<a href="pizzas-tropical.php"><img src="images/p-off-tropical.png"></a>
		  		...
		  		<a href="pizzas-rucula.php"><img src="images/p-on-ruculajamon.png"></a>
