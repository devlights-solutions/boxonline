...
$cons = mysql_query("SELECT * FROM submenu  where id = 6 and subid = 59");
...
<title>BOX - Lomo mediterraneo</title>
<!-- InstanceEndEditable -->
            	...
            	<div id="barra" >
               	  <div id="barra-inner" class="left bg-barra-inner">
                  	<ul id="barra-inner">
                        ...
                        <li><a href="hamburguesas-comun.php"><span class="btn3_active">hambuerguesas y lomos</span></a></li>
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-lomo-mediterraneo.png" width="562" height="342" alt="Imagen Empanadas &aacute;rabes" />
				
                <!--OPCIONES-->
          <div class="opciones-lomos-hambur">
                	<ul class="gallery">
                            <li class="left">
                                <a href="fritas-papas.php?iframe=true&amp;width=800&amp;height=548" rel="prettyPhoto[iframe]">
                        	<img src="images/blank-fritas.png" width="140" height="180" />
                            </a></li>
                            <li class="left">
                                <a href="fritas-mandibox.php?iframe=true&amp;width=800&amp;height=548" rel="prettyPhoto[iframe]">
                        	<img src="images/blank-fritas.png" width="140" height="180" />
                            </a></li>
                            <li class="left">
                                <a href="fritas-smiles.php?iframe=true&amp;width=800&amp;height=548" rel="prettyPhoto[iframe]">
                        	<img src="images/blank-fritas.png" width="140" height="180" />
                            </a></li>
                            <li class="left">
                                <a href="fritas-apuai.php?iframe=true&amp;width=800&amp;height=548" rel="prettyPhoto[iframe]">
                        	<img src="images/blank-fritas.png" width="140" height="180" />
                            </a></li>
                  </ul>
            	...
            	<div id="container-slider2">
					...
					<div id="slider">
                        <ul>
                            ...
                            <li>
                            	<!--PAG 2 -->
                             	<a href="lomos-completo.php"><img src="images/l-off-completo.png" class="left" /></a>
                                <a href="lomos-arabe.php"><img src="images/l-off-arabe.png" class="left" /></a>
                                <a href="lomos-maxibox.php"><img src="images/l-off-maxilomo.png" class="left" /></a>
                                <a href="lomos-primavera.php"><img src="images/l-off-sandwichprimavera.png" class="left" /></a>
                                <a href="lomos-mediterraneo.php"><img src="images/l-off-mediterraneo.png" class="left" /></a>
                              <div class="clear"></div>
                          ...
                          <li>
                            	<!--PAG 1 -->
                             	<a href="hamburguesas-comun.php"><img src="images/h-off-comun.png" class="left" /></a>
                                <a href="hamburguesas-completa.php"><img src="images/h-off-competa.png" class="left" /></a>
                                <a href="hamburguesas-maxibox.php"><img src="images/h-off-maxibox.png" class="left" /></a>
                                <a href="lomos-comun.php"><img src="images/l-off-comun.png" class="left" /></a>
                              <div class="clear"></div>
