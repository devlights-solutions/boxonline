...
$cons = mysql_query("SELECT * FROM submenu  where id = 16 and subid = 133"); //fanta grande
...
<div id="4bloque_bg" class="bg-4bloque">
	<div class="w-960">
    	<div id="body">
			...
			<!--BEBIDAS-->
            <div id="bebidas" class="bg-bebidas2">
            	<!-- IMAGEN-->
                <div class="left w-360">
                	<div id="img-bebidas2">
                    	<span class="fanta3"></span>
                    </div>
                </div>
                    ...
                    <div id="precio-gaseo">
                        ...
                        <div class="w-precio-bebidas">
                            ...
                            <div class="inner-precio-bebidas p_T_18">
                                <!-- PRECIO -->
                                    <div class=" pesos"><span class="costo"> <?php 
                     ...
                     <!--/// wrapper precio-->
                        ...
                        <div id="bot-gaseosas">
                        	<ul id="bot-gaseosas">
                            	<li><a href="bebidas-g1.php" target="_self"><span class="btn1"></span></a></li>
                                <li><a href="bebidas-g2.php" target="_self"><span class="btn2"></span></a></li>
                                <li><a href="bebidas-g3.php" target="_self"><span class="btn3"></span></a></li>
                                <li><a href="bebidas-g4.php" target="_self"><span class="btn4"></span></a></li>
                                <li><a href="bebidas-g5.php" target="_self"><span class="btn5"></span></a></li>
                                <li><a href="bebidas-g6.php" target="_self"><span class="btn6"></span></a></li>
                                <li><a href="bebidas-g7.php" target="_self"><span class="btn7"></span></a></li>
                                <li><a href="bebidas-g8.php" target="_self"><span class="btn8"></span></a></li>
                                <li><a href="bebidas-g9.php" target="_self"><span class="btn9"></span></a></li>
                                <li><a href="bebidas-g10.php" target="_self"><span class="btn10"></span></a></li>
                                <li><a href="bebidas-g11.php" target="_self"><span class="btn11"></span></a></li>
                                <li><a href="bebidas-g12.php" target="_self"><span class="btn12"></span></a></li>
                                <li><a href="bebidas-g13.php" target="_self"><span class="btn13_active"></span></a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="w-740">
                	<div id="bot-bebidas" class="p_T_18 p_B_18">
                    	<ul >
                        	<li><a href="bebidas-g1.php" target="_self"><span class="btn1_active">Gaseosas</span></a></li>
                            ...
                            <li><a href="bebidas-v1.php" target="_self"><span class="btn4">Vinos</span></a></li>
