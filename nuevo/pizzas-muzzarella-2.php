...
$cons = mysql_query("SELECT * FROM submenu  where id = 1 and subid = 9");//pizza muzza
...
<title>BOX - Pizza muzzaarella</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-pizzas-muzz.png" width="562" height="339" alt="Imagen Empanadas &aacute;rabes" />
            	...
            	<div id="container-slider">
					...
					<div id="slider">
                        <ul>
                            ...
                            <li>
                            	<!--PAG 1 - 3 gustos-->
                                <a href="pizzas-muzzarella.php" target="_self"><img src="images/p-off-muzzarella.png" class="left" /></a>
                                <a href="pizzas-fugazzeta.php" target="_self"><img src="images/p-off-fugaceta.png" class="left" /></a>
                                <a href="pizzas-fugazzeta-panceta.php" target="_self"><img src="images/p-off-fugacetapanceta.png" class="left" /></a>
                              <div class="clear"></div>
              </li>
