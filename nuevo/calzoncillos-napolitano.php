...
$cons = mysql_query("SELECT * FROM submenu  where id = 2 and subid = 27");
...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/calzoncillos.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />

<!-- InstanceBeginEditable name="doctitle" -->
<title>BOX - Calzoncillo napolitano</title>
<!-- InstanceEndEditable -->
            	...
            	<div id="barra" >
               	  <div id="barra-inner" class="left bg-barra-inner">
                  	<ul id="barra-inner">
                        ...
                        <li><a href="calzoncillos-fugazzeta.php"><span class="btn5_active">calzones</span></a></li>
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-calzoncillo-pruebaborrar.png" width="562" height="530" alt="Imagen Calzoncillo Fugaceta" />
                ...
                <div class="w-895">
                	<div id="bot-calzoncillo" class="p_T_18 p_B_18">
                    	<ul id="bot-calzoncillo">
                        	<li><a href="calzoncillos-fugazzeta.php"><span class="btn1">Calzoncillo Fugaceta</span></a></li>
                            <li><a href="calzoncillos-napolitano.html"><span class="btn2_active">Calxon Napolitano</span></a></li>
                            <li><a href="calzoncillos-granbox.php"><span class="btn3">Calzoncillo Gran Box</span></a></li>
                            <li><a href="calzoncillos-especial.php"><span class="btn4">Calzoncillo Especial</span></a></li>
                        </ul>
                        <div class="clear"></div>
                    </div>
                </div>
