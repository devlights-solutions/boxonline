...
$cons = mysql_query("SELECT * FROM submenu  where id = 5 and subid = 52");
...
<title>BOX - Hamburguesa Maxi Box</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-hambur-maxibox.png" width="562" height="342" alt="Imagen Empanadas &aacute;rabes" />
