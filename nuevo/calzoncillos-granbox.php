...
$cons = mysql_query("SELECT * FROM submenu  where id = 2 and subid = 28");
...
<title>BOX - Calzoncillo Gran Box</title>
<!-- InstanceEndEditable -->
                ...
                <div class="w-895">
                	<div id="bot-calzoncillo" class="p_T_18 p_B_18">
                    	<ul id="bot-calzoncillo">
                            ...
                            <li><a href="calzoncillos-granbox.html"><span class="btn3_active">Calzoncillo Gran Box</span></a></li>
