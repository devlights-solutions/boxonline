...
$cons = mysql_query("SELECT * FROM submenu  where id = 13 and subid = 111");
...
<div class="left w-800">
  <div class="left w-372"><img src="images/img-papas-apuai.jpg" width="372" height="548" /></div>
    ...
    <div id="precio-fritas" class="left">
        ...
        <div id="bot-fritas">
                    	<ul id="bot-fritas">
                            ...
                            <li><a href="#"><span class="btn4_active">Apuaí</span></a></li>
              </ul>
            </div>
        <!-- /// botonera-->
        </div>
