...
$cons = mysql_query("SELECT * FROM submenu  where id = 8 and subid = 70");
...
<title>BOX - Wok de pollo y vegetales</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-wok-pollo-veg.png" alt="Imagen Calzoncillo Fugaceta" width="562" height="530" border="0" usemap="#Map" />
                    <map name="Map" id="Map">
                      <area shape="rect" coords="10,339,263,496" href="wok-pollo-veg-arroz.php" target="_self" />
