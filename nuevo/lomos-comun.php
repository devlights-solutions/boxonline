...
$cons = mysql_query("SELECT * FROM submenu  where id = 6 and subid = 53");
...
<title>BOX - Lomo com&uacute;n</title>
<!-- InstanceEndEditable -->
	...
	<div class="w-960">
    	<div id="body">
            ...
            <div class="w-916">
                ...
                <div class="col560 left"><!-- InstanceBeginEditable name="imagen" --><img src="images/img-lomo-comun.png" width="562" height="342" alt="Imagen Empanadas &aacute;rabes" />
