...
<div class=" w-680 bg-agregados-wok">
	<div id="agregados-wok">
            	...
            	<div class="inner-agregado">
                    ...
                    <!-- PRECIO -->
                                <div class="pesos-rojo2"><span class="costo-rojo2">
                                 <?php 
								 $cons = mysql_query("SELECT * FROM submenu  where id = 9 and subid = 79");
            ...
            <span class="wok4">
            	<div class="inner-agregado">
                    ...
                    <!-- PRECIO -->
                                <div class="pesos-rojo2"><span class="costo-rojo2">
                                 <?php 
								  $cons = mysql_query("SELECT * FROM submenu  where id = 9 and subid = 82");
$consrow=mysql_fetch_array($cons);
$precio1 = $consrow['subPrecio1'];
									$decimales = explode(".",$precio1);
									if ($decimales[1] == '00') {
            ...
            <span class="wok2">
            	<div class="inner-agregado">
                    ...
                    <!-- PRECIO -->
                                <div class="pesos-rojo2"><span class="costo-rojo2">
                                 <?php 
								  $cons = mysql_query("SELECT * FROM submenu  where id = 9 and subid = 80");
$consrow=mysql_fetch_array($cons);
$precio1 = $consrow['subPrecio1'];
									$decimales = explode(".",$precio1);
									if ($decimales[1] == '00') {
            ...
            <span class="wok5">
            	<div class="inner-agregado">
                    ...
                    <!-- PRECIO -->
                                <div class="pesos-rojo2"><span class="costo-rojo2">
                                 <?php 
								  $cons = mysql_query("SELECT * FROM submenu  where id = 9 and subid = 83");
$consrow=mysql_fetch_array($cons);
$precio1 = $consrow['subPrecio1'];
									$decimales = explode(".",$precio1);
									if ($decimales[1] == '00') {
            ...
            <span class="wok3">
            	<div class="inner-agregado">
                    ...
                    <!-- PRECIO -->
                                <div class="pesos-rojo2"><span class="costo-rojo2">
                                 <?php 
								  $cons = mysql_query("SELECT * FROM submenu  where id = 9 and subid = 81");
$consrow=mysql_fetch_array($cons);
$precio1 = $consrow['subPrecio1'];
									$decimales = explode(".",$precio1);
									if ($decimales[1] == '00') {
