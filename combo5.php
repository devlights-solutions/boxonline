...
$cons = mysql_query("SELECT * FROM submenu  where id = 14 and subid = 112");
...
<div id="4bloque_bg" class="bg-4bloque">
	<div class="w-960">
      ...
      <img src="images/img-combo5.png" width="560" height="530" alt="Combo5" class="right" />
